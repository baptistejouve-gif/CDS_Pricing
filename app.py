...
st.markdown("""
**Auteur:** Jouve Baptiste| Ce tableau de bord interactif calcule la valorisation simplifiée d'un CDS et modélise la courbe de survie implicite de l'entité de référence en temps réel.""")
